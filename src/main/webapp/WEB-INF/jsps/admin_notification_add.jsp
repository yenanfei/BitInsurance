                                ...
                                <div id="Resign" >
                                    ...
                                    <div class="form-group" align="right">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button class="btn btn-primary"  onclick="addnews()">确认新增</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" >
    $(document).ready(function () {
        document.getElementById("newsnanme").value="";
        document.getElementById("newstext").value="";
    })

    function addnews() {
        var id = {
            newsnanme: $("#newsnanme").val(),
        ...
        $.ajax({
            ...
            success: function (data) {
                alert("新增成功");
                document.location.href="notificationmanage";
