    ...
    function buyInsurance(){
        $("#contentTable").find("tr").each(function () {
            this.onclick = function () {
                var nextPath = "buyinsurance?id=" + this.id;
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                text.append(text2);
                tr.append(text);
                var str_td = "<button onClick=\"buyInsurance()\" class=\"btn btn-primary\" align=\"right\">我要投保</button>";
                var td = $(str_td);
                tr.append(td);
                $("#table").append(tr);
            }
