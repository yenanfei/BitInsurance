                ...
                <section class="panel">
                    ...
                    <div class="form-group" align="right">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button class="btn btn-primary"  onclick="addnotification()">添加通知</button>
                        </div>
                    </div>
                </section>
            </div>
...
<script type="text/javascript">
    function addnotification() {
        window.location.href = "addNotification";
    }

    function viewnotification() {
        $("#contentTable").find("tr").each(function () {
            this.onclick = function () {
                var nextPath = "notificationView?id=" + this.id;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = 0, e = result.length; i < e; i++) {
                    ...
                    var tr = $(str_tr);
                    var td = $("<td></td>");
                    td.text(result[i][0]);//通知标题
                    tr.append(td);
                    var str_td = "<button onClick=\"deletenotification()\" class=\"btn btn-primary\">删除通知</button>";
                    var td = $(str_td);
                    var td2 = $("<td></td>");
                    td2.append(td);
                    tr.append(td2);
                    var td3 = $("<td></td>");
                    var str_td2 = "<button onClick=\"viewnotification()\" class=\"btn btn-primary\">查看通知</button>";
                    var td = $(str_td2);
                    td3.append(td);
                    tr.append(td3);
                    $("#table").append(tr);
