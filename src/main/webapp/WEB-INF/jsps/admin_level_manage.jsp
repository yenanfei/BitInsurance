                    ...
                    <section class="panel">
                        ...
                        <div class="form-group" align="right">
                            <div class="col-lg-offset-2 col-lg-10">
                                <button class="btn btn-primary" onclick="addclerk()">新增业务员</button>
                            </div>
                        </div>
                    </section>
                </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = 0, e = result.length; i < e; i++) {
                    ...
                    var tr = $(str_tr);
                    var td = $("<td></td>");
                    td.text(result[i][0]);//名字
                    tr.append(td);
                    var td = $("<td></td>");
                    td.text(result[i][1]);//ID
                    tr.append(td);
                    var str_td = "<button onClick=\"deleteclerk()\" class=\"btn btn-primary\">删除业务员</button>";
                    var td = $(str_td);
                    var td2 = $("<td></td>");
                    td2.append(td);
                    tr.append(td2);
